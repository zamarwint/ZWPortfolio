...
// Error content and Success content for the modal.
export const errorContent = ({ errorMessage }: any): JSX.Element => {
    return (
        <>
            <svg
                viewBox="0 0 24 24"
...
export const successContent = ({ successMessage }: any): JSX.Element => {
    return (
        <>
            <svg
